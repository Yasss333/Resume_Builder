...
const Features = () => {
  ...
  return (
    ...
    <div id='features' className='flex flex-col items-center my-8 scroll-mt-10'>
        ...
        <Title title='Build Your resume Fast ⚡' description='Our Streamlined proccess helps you create resumes at a blazing fast speed with AI integration into the application .'/>
