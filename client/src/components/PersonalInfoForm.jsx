  ...
  import {User, Mail, Phone, MapPin, BriefcaseBusiness, Shield, AppWindow} from 'lucide-react'
  const PersonalInfoForm = ({
    ...
    const handleChange = (field, value) => {
      ...
      {key:"profession", label:"Proffesion", icon:BriefcaseBusiness, type:"text", required:true},
