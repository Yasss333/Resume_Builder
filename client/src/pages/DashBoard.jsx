          ...
          {resumes?.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className="absolute text-[12px] bottom-1 text-slate-600 group-hover:text-slate-950 transition-all duration-300 text-center py-2"
                  style={{ color: baseColor + "40" }}
                >
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full py-2 px-4 mb-3   focus:border-green-500  ring-green-500"
                required
              />
